...
def print_list():
    ...
    for j in range(len(score_list)):
        print((str(j+1)+".").ljust(5), " ", str(score_list[j][0]).rjust(20), " ", str(score_list[j][1]).rjust(4), " ",  str(score_list[j][2]).rjust(4), " ", str(score_list[j][3]).rjust(4), " ", str(score_list[j][4]).rjust(27), sep="")
    print("*********************************************************************")
...
def calculate_total():
    ...
    for j in range(len(score_list)):
        korean_total += score_list[j][1]
        english_total += score_list[j][2]
        math_total += score_list[j][3]
...
def check_top():
    ...
    for j in range(1, len(score_list)):
        if score_list[j][1] + score_list[j][2] + score_list[j][3] == score_list[j-1][1] + score_list[j-1][2] + score_list[j-1][3]:
            top_count += 1
